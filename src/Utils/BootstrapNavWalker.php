 ...
 *
 * Updated and modified by True Agency
 * - Support parameters to enable/disable dropdown
 */
class BootstrapNavWalker extends \Walker_Nav_Menu
{
    /**
     * @var boolean Enable/disable dropdown feature for children menu
     */
    protected $enableDropdown = true;

    public function __construct($params = [])
    {
        $dropdown = array_get($params, 'dropdown');
        if (!is_null($dropdown)) {
            $this->enableDropdown = boolval($dropdown);
        }
    }
    ...
    public function start_el(&$output, $item, $depth = 0, $args = [], $id = 0)
    {
        ...
        if (in_array('menu-item-has-children', $classes)) {
            $class_names .= $this->enableDropdown ? ' dropdown' : '';
        }
        ...
        if ($depth === 0 && in_array('menu-item-has-children', $classes) && $this->enableDropdown) {
